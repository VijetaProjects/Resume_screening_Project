...
def generate_requirements(skill, job_description):
    prompt = f"Explain how much the skill '{skill}' is required for the job role in the following job description.\n\nJob Description:\n{job_description}"
...
output_file = "evaluation_sheet_first_record_updated4.xlsx"
