...
def pdfs_to_cleaned_and_extracted_excel(pdf_folder, final_excel_path):
    ...
    for filename in os.listdir(pdf_folder):
        if filename.endswith(".pdf"):
            ...
            linkedin_links_str = ', '.join(linkedin_links)
...
final_excel_file = r"C:\Users\vijet\OneDrive\Desktop\Profiling Project\Experimentation Documents\Daily Work\21 Aug\Final Code 0\final_resume_info.xlsx"
