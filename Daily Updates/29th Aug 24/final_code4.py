...
# Function to retrieve relevant documents from the knowledge base using RAG
def retrieve_relevant_documents(query_text, documents):
...
def pdfs_to_cleaned_and_extracted_excel(resume_folder, job_description_file, skills_file, final_excel_path):
    ...
    # Load the knowledge base (job description and skills)
    knowledge_base = [job_description_text] + skills  # Assuming skills are short texts
    ...
    for filename in os.listdir(resume_folder):
        ...
        if filename.endswith((".pdf", ".docx", ".txt")):
            ...
            fitment_summary_text = retrieve_relevant_documents(cleaned_text, knowledge_base)
            summary = fitment_summary(cleaned_text, fitment_summary_text)
...
final_excel_path = 'final_output4.xlsx'
